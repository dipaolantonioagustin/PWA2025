namespace TpDiPaolantonioPWA.Models
{
    public class _Eventos
    {
        ...
        public List<_Eventos> ListarEventos()
        {
            List<_Eventos> listaEventos = new List<_Eventos>();


            _Eventos e1 = new _Eventos();
            e1.id = 1;
